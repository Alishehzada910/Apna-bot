...
if ((event.body.toLowerCase() == "🦗")) {
  ...
  if((event.body.tolowerCase() == "Lol") || event.body.tolowerCase() == "lul") || event.body.tolowerCase() == "LOL")) {
     return api.sendMessage("⚠️SHAT UP BAD WORD USE KR KY TARBIYAT SHOW NA KRA", threadID);
};
